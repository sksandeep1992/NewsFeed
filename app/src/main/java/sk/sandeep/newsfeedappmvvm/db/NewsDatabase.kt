...
/**
 * A database that stores Article information.
...
abstract class NewsDatabase : RoomDatabase() {
    ...
    /**
     * Define a companion object, this allows us to add functions on the NewsDatabase class.
     *
     * For example, clients can call `NewsDatabase.getInstance(context)` to instantiate
     * a new NewsDatabase.
     */
    companion object {
        /**
